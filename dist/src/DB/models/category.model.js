...
exports.CategorySchema.pre("save", async function () {
    if (this.isModified("name")) {
        this.slug = (0, slugify_1.default)(this.name, { lower: true });
    }
});
exports.CategoryModel = mongoose_1.MongooseModule.forFeature([
    {
        name: Category.name,
        schema: exports.CategorySchema,
    },
]);
